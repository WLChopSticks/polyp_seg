...
def get_img_gt_result_draw(dataset_root=None, dataframe=None, index=None, transform=None,
    ...
    savepath = os.path.join(savedir, patient_id.split('/')[-1]+'_'+dcm_name+'.SVG')
    if draw_contour:
        overlapping = draw_edge_on_image(gt, mask_origin_size, img, savepath, show=False)
    if True:
        overlapping_pil = Image.fromarray(cv2.cvtColor(overlapping, cv2.COLOR_BGR2RGB))
        plt.figure(figsize=(20, 17), dpi=72)
        plt.subplot(221)
        plt.imshow(img)
        # plt.axis('off')
        plt.title('original image')
        plt.subplot(222)
        plt.imshow(overlapping_pil)
        # plt.axis('off')
        plt.title('orig image covered with gt&result')
        plt.subplot(223)
        plt.imshow(gt, 'gray')
        # plt.axis('off')
...
# val_csv_path = '/home/dell/jx/Projects/utils/dcm_split_5fold/T2WIFS/val_data_split1.csv'
# dataset_root = '/home/dell/jx/data/直肠癌/T2WIFS_AXI_194'
# savedir = '/home/dell/jx/Seg/分割结果可视化/t2wifs'
# param_path = '/home/dell/jx/Seg/weights/调参后的baseline/T2WIFS_fold1_baseline256.pkl'
...
# param_path = '/home/dell/jx/Seg/weights/调参后的baseline/T2WI_fold1_baseline256.pkl'

val_csv_path = '/home/dell/jx/Projects/utils/dcm_split_5fold/T1WI/val_data_split1.csv'
dataset_root = '/home/dell/jx/data/直肠癌/T1WI_194'
savedir = '/home/dell/jx/Seg/分割结果可视化/t1wi'
param_path = '/home/dell/jx/Seg/weights/调参后的baseline/t1wi_fold1_baseline256.pkl'
